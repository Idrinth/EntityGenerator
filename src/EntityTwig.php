...
class EntityTwig extends Twig_Extension {
    ...
    public function getFilters() {
        return array(
            new Twig_SimpleFilter('toLowerCamelCase','De\Idrinth\EntityGenerator\EntityTwig::toLowerCamelCase'),
            new Twig_SimpleFilter('toUpperCamelCase','De\Idrinth\EntityGenerator\EntityTwig::toUpperCamelCase'),
        );
    }
}